...
\lstinputlisting{./source/01_Miscellaneous/00_What to Look for.txt}
...
\lstinputlisting[language=c++]{./source/02_Data Structures/00_Segment Tree.cpp}
\subsection{STL PBDS}
...
\subsection{Mo's on Array}
\lstinputlisting[language=c++]{./source/02_Data Structures/10_Mo's on Array.cpp}
\section{Dynamic Programming}
\subsection{DP CHT}
\lstinputlisting[language=c++]{./source/03_Dynamic Programming/01.2_DP CHT.cpp}
\subsection{DP DNC}
...
\subsection{DP SOS}
\lstinputlisting[language=c++]{./source/03_Dynamic Programming/04_DP SOS.cpp}
\section{Geometry}
...
\subsection{Dinic's Tourist}
\lstinputlisting[language=c++]{./source/05_Graphs/04.2_Dinic's Tourist.cpp}
\subsection{Bipartite Graphs}
\input{./source/05_Graphs/04.3_Bipartite Graphs.tex}
...
\lstinputlisting[language=c++]{./source/07_Strings/07_Z Function.cpp}
\section{OEIS}
...
\subsection{A000127}
\lstinputlisting{./source/08_OEIS/04_A000127.txt}
\subsection{A001534}
\lstinputlisting{./source/08_OEIS/05_A001534.txt}
